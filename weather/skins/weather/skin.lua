...
-- Hero block.
text{ value = "location", x = 28, y = 40, size = 26, color = PRI }
text{ value = "condition_text", x = 28, y = 76, size = 14, color = SEC }
text{ value = "temp_now", x = 28, y = 108, size = 72, color = PRI }
text{ value = "hi_lo", x = 30, y = 198, size = 14, color = SEC }
text{ value = "feels", x = 160, y = 198, size = 14, color = SEC }
...
list{ collection = "daily", x = 24, y = 312, w = W - 48, h = 238, row_height = 34,
      template = {
        { bind = "day",   x = 8,        y = 8, size = 15, color = PRI },
        { bind = "glyph", x = 120,      y = 6, size = 17, color = { r = 245, g = 240, b = 220 } },
        { bind = "hi",    right = 70,   y = 8, size = 15, color = PRI },
        { bind = "lo",    right = 10,   y = 8, size = 15, halign = "right", color = LO },
      } }
