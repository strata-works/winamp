...
fn main() {
    ...
    unsafe {
        ...
        let mut seed: u32 = 0;
        IOSurfaceLock(surface_ref, io_surface::IOSurfaceLockOptions::kIOSurfaceLockReadOnly, &mut seed);
        ...
        IOSurfaceUnlock(surface_ref, io_surface::IOSurfaceLockOptions::kIOSurfaceLockReadOnly, &mut seed);
